...
namespace ChecksumHashTests
{
	TEST_CASE("Crc32CastagnoliTests")
	{
		...
		std::string HashOfDefaultData = "22B17746";
		std::string HashOfOnetoNine = "E3069283";
		std::string HashOfABCDE = "C450D697";

		IHash HashInstance = HashFactory::Checksum::CreateCRC32_CASTAGNOLI();
