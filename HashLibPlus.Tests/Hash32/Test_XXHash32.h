...
namespace Hash32Tests
{
	...
	{
		std::string HashOfEmptyData = "02CC5D05";
		std::string HashOfDefaultData = "6A1C7A99";
		std::string HashOfOnetoNine = "937BAD67";
		std::string HashOfABCDE = "9738F19B";
		std::string HashOfDefaultDataWithFourByteKey = "728C6772";
