...
namespace Hash32Tests
{
	TEST_CASE("Murmur2_32Tests")
	{
		...
		std::string HashOfDefaultData = "30512DE6";
		std::string HashOfOnetoNine = "DCCB0167";
		std::string HashOfABCDE = "5F09A8DE";
		std::string HashOfDefaultDataWithFourByteKey = "B15D52F0";
