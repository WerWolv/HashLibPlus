...
namespace Hash32Tests
{
	TEST_CASE("MurmurHash3_x86_32Tests")
	{
		...
		std::string HashOfDefaultData = "3D97B9EB";
		std::string HashOfOnetoNine = "B4FEF382";
		std::string HashOfABCDE = "E89B9AF6";
		std::string HashOfDefaultDataWithFourByteKey = "B05606FE";
