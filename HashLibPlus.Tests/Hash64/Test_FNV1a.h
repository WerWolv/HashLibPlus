...
namespace Hash64Tests
{
	...
	{
		std::string HashOfEmptyData = "CBF29CE484222325";
		std::string HashOfDefaultData = "5997E22BF92B0598";
		std::string HashOfOnetoNine = "06D5573923C6CDFC";
		std::string HashOfABCDE = "6348C52D762364A8";
