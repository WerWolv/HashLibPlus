...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "4441BE75F6018773C206C22745374B924AA8313FEF919F41";
		std::string HashOfDefaultData = "DEB1924D290E3D5567792A8171BFC44F70B5CD13480D6D5C";
		std::string HashOfOnetoNine = "82FAF69673762B9FD8A0C902BDB395C12B0CBDDC66957838";
		std::string HashOfABCDE = "E1F0DAC9E852ECF1270FB691C35506D4BEDB12A09D6BF911";
		std::string HashOfDefaultDataWithHMACWithLongKey = "AB8648339AF3C379C16E3595539E787A3464E7BB30810F2A";
		std::string HashOfDefaultDataWithHMACWithShortKey = "C70FA522EACE7D870F914A086BD1D9807A6FDC405C5A09DB";
