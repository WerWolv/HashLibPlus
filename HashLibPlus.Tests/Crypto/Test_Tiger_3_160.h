...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "4441BE75F6018773C206C22745374B924AA8313F";
		std::string HashOfDefaultData = "DEB1924D290E3D5567792A8171BFC44F70B5CD13";
		std::string HashOfOnetoNine = "82FAF69673762B9FD8A0C902BDB395C12B0CBDDC";
		std::string HashOfABCDE = "E1F0DAC9E852ECF1270FB691C35506D4BEDB12A0";
		std::string HashOfDefaultDataWithHMACWithLongKey = "A8CC78CCD014F6A08AF1267E12D05FA472904E4D";
		std::string HashOfDefaultDataWithHMACWithShortKey = "71028DCDC197492195110EA5CFF6B3E04912FF25";
