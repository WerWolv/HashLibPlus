...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "184B8482A0C050DCA54B59C7F05BF5DD";
		std::string HashOfDefaultData = "B335D2DC38EFB9D937B803F7581AF88D";
		std::string HashOfOnetoNine = "8AA1C1CA3A7E4F983654C4F689DE6F8D";
		std::string HashOfABCDE = "11C0532F713332D45D6769376DD6EB3B";
		std::string HashOfDefaultDataWithHMACWithShortKey = "1D5D93E71FF0B324C54ADD1FBDE1F4E4";
		std::string HashOfDefaultDataWithHMACWithLongKey = "931DFA421EB8538C9713C453D47B916D";
