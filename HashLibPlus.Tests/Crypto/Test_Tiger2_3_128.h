...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "4441BE75F6018773C206C22745374B92";
		std::string HashOfDefaultData = "DEB1924D290E3D5567792A8171BFC44F";
		std::string HashOfOnetoNine = "82FAF69673762B9FD8A0C902BDB395C1";
		std::string HashOfABCDE = "E1F0DAC9E852ECF1270FB691C35506D4";
		std::string HashOfDefaultDataWithHMACWithLongKey = "610CA106E5C500E6E073C337D6CF9C63";
		std::string HashOfDefaultDataWithHMACWithShortKey = "0393C69DD393D9E15C723DFAE88C3059";
