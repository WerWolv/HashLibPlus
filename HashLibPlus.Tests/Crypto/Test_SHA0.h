...
namespace CryptoHashTests
{
	TEST_CASE("SHA0Tests")
	{
		std::string HashOfEmptyData = "F96CEA198AD1DD5617AC084A3D92C6107708C0EF";
		std::string HashOfDefaultData = "C9CBBE593DE122CA36B13CC37FE2CA8D5606FEED";
		std::string HashOfDefaultDataWithHMACWithLongKey = "3AD935BE61BBC3913312A27279EED889648E967F";
		std::string HashOfDefaultDataWithHMACWithShortKey = "EAA73E85DCAC5BAD0A0E71C0695F901FC32DB38A";
		std::string HashOfOnetoNine = "F0360779D2AF6615F306BB534223CF762A92E988";
		std::string HashOfABCDE = "D624E34951BB800F0ACAE773001DF8CFFE781BA8";
