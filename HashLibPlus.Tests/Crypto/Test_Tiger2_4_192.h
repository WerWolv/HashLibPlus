...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "6A7201A47AAC2065913811175553489ADD0F8B99E65A0955";
		std::string HashOfDefaultData = "22EE5BFE174B8C1C23361306C3E8F32C92075577F9115C2A";
		std::string HashOfOnetoNine = "75B7D71ACD40FE5B5D3263C1F68F4CF5A5DA963B39413ACA";
		std::string HashOfABCDE = "9FBB0FBF818C0302890CE373559D23702D87C69B9D1B29D5";
		std::string HashOfDefaultDataWithHMACWithLongKey = "EE9F8B721F29C5085FF542F170ED9AF33B0D58229632E248";
		std::string HashOfDefaultDataWithHMACWithShortKey = "3B182344C171E8843B3D30887274FC7248A7CCD49AA84E77";
