...
namespace CryptoHashTests
{
	TEST_CASE("SHA1Tests")
	{
		std::string HashOfEmptyData = "DA39A3EE5E6B4B0D3255BFEF95601890AFD80709";
		std::string HashOfDefaultData = "C8389876E94C043C47BA4BFF3D359884071DC310";
		std::string HashOfDefaultDataWithHMACWithLongKey = "956B4A490ECD0AE453D9927DABDCBC35E6E4BE51";
		std::string HashOfDefaultDataWithHMACWithShortKey = "CD409025AA5F34ABDC660856463155B23C89B16A";
		std::string HashOfOnetoNine = "F7C3BC1D808E04732ADF679965CCC34CA7AE3441";
		std::string HashOfABCDE = "03DE6C570BFE24BFC328CCD7CA46B76EADAF4334";
