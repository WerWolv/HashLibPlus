...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "6A7201A47AAC2065913811175553489ADD0F8B99";
		std::string HashOfDefaultData = "22EE5BFE174B8C1C23361306C3E8F32C92075577";
		std::string HashOfOnetoNine = "75B7D71ACD40FE5B5D3263C1F68F4CF5A5DA963B";
		std::string HashOfABCDE = "9FBB0FBF818C0302890CE373559D23702D87C69B";
		std::string HashOfDefaultDataWithHMACWithLongKey = "C5EC439F91CC537CCF013E33F88ABCBCC05AE365";
		std::string HashOfDefaultDataWithHMACWithShortKey = "283A6ED11043AAA947A12843DC5C4B16283BE633";
