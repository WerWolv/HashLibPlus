...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "61C657CC0C3C147ED90779B36A1E811F";
		std::string HashOfDefaultData = "7F71F95B346733E7022D4B85BDA9C51E";
		std::string HashOfOnetoNine = "F720446C9BFDC8479D9FA53BC8B9144F";
		std::string HashOfABCDE = "14F45FAC4BE0302E740CCC6FE99D75A6";
		std::string HashOfDefaultDataWithHMACWithLongKey = "7D5547482639AE44E3CA6E16AEEE118A";
		std::string HashOfDefaultDataWithHMACWithShortKey = "F545BB88FBE3E5FB85E6DE063D081B66";
