...
namespace CryptoHashTests
{
	TEST_CASE("MD4Tests")
	{
		std::string HashOfEmptyData = "31D6CFE0D16AE931B73C59D7E0C089C0";
		std::string HashOfDefaultData = "A77EAB8C3432FD9DD1B87C3C5C2E9C3C";
		std::string HashOfDefaultDataWithHMACWithLongKey = "72F808BCE6C0E340813B3A4F6173F452";
		std::string HashOfDefaultDataWithHMACWithShortKey = "BF21F9EC05E480EEDB12AF20181713E3";
		std::string HashOfOnetoNine = "2AE523785D0CAF4D2FB557C12016185C";
		std::string HashOfABCDE = "9803F4A34E8EB14F96ADBA49064A0C41";
