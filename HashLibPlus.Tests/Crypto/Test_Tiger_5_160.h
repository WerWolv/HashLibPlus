...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "E765EBE4C351724A1B99F96F2D7E62C9AACBE64C";
		std::string HashOfDefaultData = "D6B8DCEA252160A4CBBF6A57DA9ABA78E4564864";
		std::string HashOfOnetoNine = "BCCCB6421B3EC291A062A33DFF21BA764596C58E";
		std::string HashOfABCDE = "1AB49D19F3C93B6FF4AB536951E5A6D05EF6394C";
		std::string HashOfDefaultDataWithHMACWithLongKey = "AD2D47B67DD7ACDB1CDEBBD8E7F47DA6F42634C2";
		std::string HashOfDefaultDataWithHMACWithShortKey = "5F403B5F7F9A341545F55265698DD77DB8D3D6D4";
