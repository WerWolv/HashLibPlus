...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "3293AC630C13F0245F92BBB1766E16167A4E58492DDE73F3";
		std::string HashOfDefaultData = "C76C85CE853F6E9858B507DA64E33DA27DE49F8601F6A830";
		std::string HashOfOnetoNine = "0672665140A491BB35040AA9943D769A47BE83FEF2126E50";
		std::string HashOfABCDE = "BFD4041233531F1EF1E9A66D7A0CEF76A3E0FE756B36A7D7";
		std::string HashOfDefaultDataWithHMACWithLongKey = "1CF2C7D3B653E2A68AA11FBBC7472DFC8F4ABE3FA51C09FB";
		std::string HashOfDefaultDataWithHMACWithShortKey = "9B53DDED2647666E9C31CF0F93B3B83E9FF64DF4532F3DDC";
