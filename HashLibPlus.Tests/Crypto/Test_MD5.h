...
namespace CryptoHashTests
{
	TEST_CASE("MD5Tests")
	{
		std::string HashOfEmptyData = "D41D8CD98F00B204E9800998ECF8427E";
		std::string HashOfDefaultData = "462EC1E50C8F2D5C387682E98F9BC842";
		std::string HashOfDefaultDataWithHMACWithLongKey = "676E69260120FC778A90993F915536FC";
		std::string HashOfDefaultDataWithHMACWithShortKey = "09F705F43799213192622CCA6DF68941";
		std::string HashOfOnetoNine = "25F9E794323B453885F5181F1B624D0B";
		std::string HashOfABCDE = "AB56B4D92B40713ACC5AF89985D4B786";
