...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "E765EBE4C351724A1B99F96F2D7E62C9";
		std::string HashOfDefaultData = "D6B8DCEA252160A4CBBF6A57DA9ABA78";
		std::string HashOfOnetoNine = "BCCCB6421B3EC291A062A33DFF21BA76";
		std::string HashOfABCDE = "1AB49D19F3C93B6FF4AB536951E5A6D0";
		std::string HashOfDefaultDataWithHMACWithLongKey = "EFDCC5015260F7954F3F135A7188708D";
		std::string HashOfDefaultDataWithHMACWithShortKey = "49D450EC293D5565CE82284FA52FDC51";
