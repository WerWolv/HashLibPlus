...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "6A7201A47AAC2065913811175553489A";
		std::string HashOfDefaultData = "22EE5BFE174B8C1C23361306C3E8F32C";
		std::string HashOfOnetoNine = "75B7D71ACD40FE5B5D3263C1F68F4CF5";
		std::string HashOfABCDE = "9FBB0FBF818C0302890CE373559D2370";
		std::string HashOfDefaultDataWithHMACWithLongKey = "0113ECE2E287D9DBD0AC836968F56E70";
		std::string HashOfDefaultDataWithHMACWithShortKey = "A24C1DD76CACA54D3CB2BDDE5E40D84E";
