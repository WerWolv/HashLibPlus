...
namespace CryptoHashTests
{
	...
	{
		std::string HashOfEmptyData = "3293AC630C13F0245F92BBB1766E1616";
		std::string HashOfDefaultData = "C76C85CE853F6E9858B507DA64E33DA2";
		std::string HashOfOnetoNine = "0672665140A491BB35040AA9943D769A";
		std::string HashOfABCDE = "BFD4041233531F1EF1E9A66D7A0CEF76";
		std::string HashOfDefaultDataWithHMACWithLongKey = "4192C0318A673DBA30F14298B93A76E4";
		std::string HashOfDefaultDataWithHMACWithShortKey = "0FA849F65841F2E621E2C882BE7CF80F";
