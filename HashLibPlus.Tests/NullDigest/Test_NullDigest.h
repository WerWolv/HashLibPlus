...
namespace NullDigestTests
{
	...
	{
		std::string HashOfEmptyData = "";
		std::string HashOfDefaultData = "486173684C69623450617363616C";
		std::string HashOfOnetoNine = "313233343536373839";
		std::string HashOfABCDE = "6162636465";
